...
public class MongodbCoreModule
{
    ...
    public static void contributeFactoryDefaults(MappedConfiguration<String, String> configuration)
    {
        ...
        configuration.add(MongoDBSymbols.FSYNC, "false");
        configuration.add(MongoDBSymbols.J, "false");
        configuration.add(MongoDBSymbols.W, "0");
        configuration.add(MongoDBSymbols.WTIMEOUT, "0");
